            ...
            <ul class="pcoded-item pcoded-left-item">
                ...
                <li class="pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        <li>
                            <a onclick="javascript:window.location.href='?page=mahasiswa'" class="waves-effect waves-dark" style="display: <?php if($hak_akses['data_siswa'] == "N"){ echo 'none;'; } ?>">
                ...
                <li class="pcoded-hasmenu active pcoded-trigger" <?php if($hak_akses['rekap_data'] == "N"){echo 'style="display:none"';}?>>
                    <a class="waves-effect waves-dark">
                        <span class="pcoded-micon">
