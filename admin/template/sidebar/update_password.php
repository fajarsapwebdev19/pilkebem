            ...
            <ul class="pcoded-item pcoded-left-item">
                ...
                <li class="pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        <li class="">
                            <a onclick="javascript:window.location.href='?page=data_siswa'" class="waves-effect waves-dark" style="display: <?php if($hak_akses['data_siswa'] == "N"){ echo 'none;'; } ?>">
                                <span class="pcoded-mtext">Data Mahasiswa</span>
                            </a>
                        </li>
                        <li class="">
                            <a onclick="javascript:window.location.href='?page=data_gtk'" class="waves-effect waves-dark" style="display: <?php if($hak_akses['data_gtk'] == "N"){ echo 'none;'; } ?>">
                ...
                <li>
                    <a onclick="javascript:window.open('../assets/user-guide/User-Guide-Admin.pdf','_blank'),reload()" class="waves-effect waves-dark">
