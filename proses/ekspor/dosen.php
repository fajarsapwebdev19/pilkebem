<?php
  ...
  ->setTitle('Pilkebem Data Dosen')
  ->setSubject('Data Dosen')
  ->setDescription('Data Dosen Pilkebem')
  ->setKeywords('Dsn')
  ->setCategory('Data Dosen');
  ...
  $i=2; 
  $no=1; 
  $query = "SELECT * FROM dosen ORDER BY kepegawaian ASC,nama ASC";
  ...
  // Rename worksheet
  $spreadsheet->getActiveSheet()->setTitle('Data Dosen '.date('d-m-Y H'));
