<?php
  ...
  $no = 1;
  $database_data = mysqli_query($koneksi, "SELECT * FROM mahasiswa WHERE kehadiran='Hadir' UNION SELECT * FROM dosen WHERE kehadiran='Hadir' ORDER BY nama ASC");
?>
<html lang="en">
<head>
  <meta charset="UTF-8">
  ...
  <title>Daftar Hadir Peserta Pemilihan Ketua BEM Tahun <?= date('Y') ?></title>
...
<body>
  <div class="row justify-content-center">
    ...
    <div class="col-sm-12 col-md-12">
      <h4 class="text-center">Daftar Hadir Peserta Pemilihan Ketua BEM Tahun <?= date('Y') ?></h4>
