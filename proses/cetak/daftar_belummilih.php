<?php
  ...
  $no = 1;
  $database_data = mysqli_query($koneksi, "SELECT * FROM mahasiswa WHERE status_memilih='Belum' UNION SELECT * FROM dosen WHERE status_memilih='Belum' ORDER BY nama ASC");
?>
<html lang="en">
<head>
  <meta charset="UTF-8">
  ...
  <title>Daftar Peserta Belum Memilih Pemilihan Ketua BEM Tahun <?= date('Y') ?></title>
...
<body>
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12">
      <h4 class="text-center">Daftar Peserta Belum Memilih Pemilihan Ketua BEM Tahun <?= date('Y') ?></h4>
...
$dompdf->render();
$title = "Daftar Peserta Belum Memilih Pemilihan Ketua BEM";
$date = date('Y');
